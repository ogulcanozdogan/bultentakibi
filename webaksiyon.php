<?php
ob_start();
$sayfa='Webaksiyon Sitelerde Ara';
include('inc/vt.php');
...
?>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Webaksiyon Siteler</h6><a style="width:15%;  float: right; margin-left:auto;
      margin-right:auto;" class="btn btn-success btn-lg" role="button" href="siteekle.php">Webaksiyon Site Ekle</a>
            </div>
 ...
 <th class="text-secondary opacity-7"></th>					  
                   ...
                   <tbody>
				  <?php
$sorgu = $baglanti->prepare("SELECT * FROM siteler WHERE platform='webaksiyon' order by id");
$sorgu->execute();
