...
?>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Gazisoft Siteler</h6><a style="width:15%;  float: right; margin-left:auto;
      margin-right:auto;" class="btn btn-success btn-lg" role="button" href="siteekle.php">Gazisoft Sitele Ekle</a>
            </div>
 ...
 <th class="text-secondary opacity-7"></th>					  
                   ...
                   <tbody>
				  <?php
$sorgu = $baglanti->prepare("SELECT * FROM siteler WHERE platform='gazisoft' order by id");
$sorgu->execute();
