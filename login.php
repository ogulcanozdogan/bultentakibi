...
<META NAME="googlebot" CONTENT="noindex,nofollow">
  ...
  <title>
    Bülten Haber Yönetim Paneli Giriş
  </title>
  <!--     Fonts and icons     -->
              ...
              <div class="card card-plain mt-8">
                ...
                <div class="card-body">
                  <form method="post" id="form1" role="form">
                    ...
                    <div class="mb-3">
                      <input name="user" id="user" class="form-control" placeholder="Username" aria-label="Username">
                    </div>
                    ...
                    <div class="text-center">
					  ...
					  <div class="container-login100-form-btn p-t-10">
							<input type="submit" class="btn bg-gradient-info w-100 mt-4 mb-0" ID="btnGiris" value="Sign in"/>
					</div>
                    </div>
                  </form>
                </div>
                        ...
                        if ($_POST) {
                            ...
                            if (md5("56" . $pass . "23") == $sonuc["pass"]) {
                                ...
                                echo "<font color='red'><strong>Kullanıcı adı veya parola yanlış!</strong></font> ";
                            }
                        }
                        ?>
